...
public class _Initializer {
    ...
    public static void Init(){
        ...
        try {
            ...
            //Init articles table
            statement = connection.prepareStatement("CREATE TABLE IF NOT EXISTS articles (id int primary key auto_increment, name varchar(100), author varchar(100) REFERENCES users(username), created_at timestamp, content longnvarchar(25000)); ");
